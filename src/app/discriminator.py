...
class Discriminator(nn.Module):
    def __init__(self, channels_img, features_d, alpha, img_size):
        ...
        layers.append(spectral_norm(nn.Conv2d(channels_img, features_d, 4, 2, 1)))
        ...
        layers.append(spectral_norm(nn.Conv2d(in_channels, in_channels * 2, 4, 2, 1)))
        layers.append(nn.LeakyReLU(alpha))
        layers.append(spectral_norm(nn.Conv2d(in_channels * 2, 1, 4, 2, 0)))
